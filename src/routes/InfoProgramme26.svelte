<script>
	...
	import IconChristening from '../icons/christening.svelte';
	import IconChurch from '../icons/church.svelte';
</script>

<section id="programme-26" class="text-primary-600 body-font">
	<h2
	...
	<div class="container px-5 py-24 pt-12 mx-auto flex flex-wrap">
		<div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
			...
			<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
				<div
					class="flex-shrink-0 w-24 h-24 bg-secondary-100 text-xxsecondary-300 rounded-full inline-flex items-center justify-center"
				>
					<span class="scale-[60%]"><IconChurch /></span>
				</div>
		...
		<div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
			...
			<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
				<div
					class="flex-shrink-0 w-24 h-24 bg-secondary-100 text-xxsecondary-300 rounded-full inline-flex items-center justify-center"
				>
					<span class="scale-75"><IconChristening /></span>
				</div>
				<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
					<h2 class="font-medium title-font text-primary-900 mb-1 text-xl">
